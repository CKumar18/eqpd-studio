  ...
  return (
    <div className="pt-32 pb-20 bg-zinc-50 dark:bg-[#0a0a0c] min-h-screen">
      <Container>
        ...
        >
          <div className="mb-16">
            <h1 className="text-4xl md:text-6xl font-bold font-display mb-6 bg-gradient-to-r from-zinc-900 to-zinc-600 dark:from-white dark:to-zinc-500 bg-clip-text text-transparent">
              Terms of Service
            </h1>
          ...
          <div className="grid gap-8">
            {terms.map((term, idx) => (
              ...
              >
                <h2 className="text-xl font-bold font-display mb-4 text-zinc-900 dark:text-white flex items-center gap-3">
